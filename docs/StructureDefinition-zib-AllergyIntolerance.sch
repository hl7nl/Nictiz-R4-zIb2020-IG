...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:category</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:category/f:extension</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:category/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:criticality</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:criticality/f:extension</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:criticality/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &lt;= 1">value[x]: maximum cardinality of 'value[x]' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:note</sch:title>
