...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:NutritionOrder">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/workflow-reasonReference']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/workflow-reasonReference': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:note) &lt;= 1">note: maximum cardinality of 'note' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:extension</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:NutritionOrder/f:oralDiet">
      <sch:assert test="count(f:texture) &lt;= 1">texture: maximum cardinality of 'texture' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:oralDiet/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:oralDiet/f:texture/f:modifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:oralDiet/f:fluidConsistencyType</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:note</sch:title>
